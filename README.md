...
│  │    world.go     │    │     ant.go      │                             │
│  │                 │    │                 │                             │
│  │ • UpdateWorld() │    │ • updateWorker()│                             │
│  │ • updateColony()│───▶│ • updateNurse() │                             │
│  │ • egg hatching  │    │ • updateSoldier│                             │
│  │ • larvae growth │    │                 │                             │
│  └─────────────────┘    └────────┬────────┘                             │
└─────────────────────────────────────────────────────────────────────────┘
                                   │
...
│                           pathfinder/                                    │
│  ┌─────────────────┐  ┌──────────────────┐  ┌────────────────────┐      │
│  │  pathfinder.go  │  │workerpathfinder.go│  │nursepathfinder.go │      │
│  │                 │  │                  │  │                    │      │
...
│   ├── colony.go           # Colony: queen, ants, resources
...
│
├── logic/                  # (the "how")
│   ├── world.go            # Per-tick world updates, egg/larvae lifecycle
...
│   ├── renderer.go         # Main render loop, stats, activity log
